					...
					<div className="row">
						<div className="col-md-8">
							...
							<p>
								...
								adipisci aut est hic illum, maxime molestias odit optio reiciendis
								sint tenetur, ut veritatis!
							</p>
							<ul>
								<li>
									Aliquam amet eum exercitationem facere illo, illum ipsam
									laboriosam modi nihil obcaecati odit optio provident, quae quas
									quia quibusdam ratione totam veniam!
								</li>
								<li>
									Asperiores, debitis eius harum, id incidunt natus quisquam quos
									repellat tempore ut veniam voluptas. Adipisci aliquam deleniti
									ea iusto quasi totam voluptatum!
								</li>
								<li>
