...
export function Alert({ type = 'information', heading, children, closable, onClose }: IProps) {
	...
	return (
		<div
			className={
				`inline-flex flex-col text-left px-4 py-3 rounded-md border-1 border-transparent ${
